...
export function AuthorByline({ author }: { author: Author }) {
  return (
    <div className="prose-measure mx-auto mt-14 flex flex-col gap-5 rounded-[14px] border border-border/70 bg-surface/40 p-6 sm:flex-row sm:items-start sm:gap-6 sm:p-7">
      {author.photo ? (
